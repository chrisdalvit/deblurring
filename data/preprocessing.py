...
#
# Copied from MIMO-UNet implementation: https://github.com/chosj95/MIMO-UNet/blob/main/data/preprocessing.py
#
...
if __name__ == '__main__':
    ...
    # Directories
    parser.add_argument('--root_src', default='./GOPRO_Large', type=str)
    parser.add_argument('--root_dst', default='./GOPRO', type=str)
